...
| 4 | 61-80 (q1501-2000) | ✅ 完成：500题/2000条 + 19 题数据问题警示 note（append_notes.py） | feat(data): 精讲批次4 500题 |
| 5 | 81-86 (q2001-2132) | ✅ 完成：132题/528条，全库 2132题/8528条全覆盖终验通过 | feat(data): 精讲批次5 132题 |

## 最终状态（2026-09-06）
- explain_collections：8528 行 = 2132 题 × 4 条，全覆盖、无重复、无孤儿、长度全部合规
