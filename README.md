...
项目当前为 `v2.2.0`。核心刷题与复习链路、公开 GitHub Actions CI、Windows NSIS 安装包、portable 便携版和 Android debug 构建门禁均已纳入验证流程；题库导入支持 CET-4/CET-6、高考英语、英语专业四级和英语专业八级模板。题库正文仍按来源和授权独立管理，不把个人数据库提交到 GitHub。
